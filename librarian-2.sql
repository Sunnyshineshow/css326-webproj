...
INSERT INTO `bookshelf` (`collection_id`, `book_id`, `bookshelf_serial`, `borrowed_status`) VALUES
(1, 1, 'F1-1', 'available'),
(2, 2, 'F1-2', 'available'),
(3, 3, 'F1-3', 'available'),
(4, 4, 'F1-4', 'available'),
...
(8, 8, 'F2-3', 'available'),
(9, 9, 'F2-4', 'available'),
(10, 10, 'F2-5', 'available'),
(11, 11, 'F3-1', 'available'),
(12, 12, 'F3-2', 'available'),
(13, 13, 'F4-3', 'available'),
(14, 14, 'F4-4', 'available'),
(15, 15, 'F4-5', 'available'),
(16, 16, 'P1-1', 'available'),
(17, 17, 'P1-2', 'available'),
(18, 18, 'P1-3', 'available'),
(19, 19, 'P1-4', 'available'),
(20, 20, 'P1-5', 'available'),
(21, 21, 'P2-1', 'available'),
(22, 22, 'Ho1-1', 'available'),
(23, 23, 'Ho1-2', 'available'),
(24, 24, 'Ho1-3', 'available'),
(25, 25, 'Ho1-4', 'available');
